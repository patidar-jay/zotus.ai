  ...
  return (
    <section className="relative overflow-hidden py-24 md:py-32">
      ...
      <Container className="relative z-10">
        ...
        >
          <h2 className="text-4xl md:text-6xl font-semibold text-white leading-[1.1] mb-6" style={{ fontFamily: 'var(--font-heading)', letterSpacing: 0 }}>
            Ready to secure your
            <br />
            environment with AI?
          </h2>
          <p className="text-lg md:text-xl text-white/70 leading-relaxed mb-10 max-w-xl mx-auto">
            From exam halls to warehouses — let's discuss how Zotus AI can transform your monitoring infrastructure.
          </p>
